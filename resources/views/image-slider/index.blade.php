        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    ...
                    <a class="btn btn-outline-primary btn-sm z-depth-0 align-self-center my-0 ml-3 py-1" href="{{ route('backend.image-sliders.create') }}">Add New</a>
                </div>
                <div class="col-sm-6">
                            ...
                            <td class="text-right">
                                <div>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('backend.image-sliders.edit', $imageSlider) }}">Edit</a>
                                        <form action="{{ route('backend.image-sliders.destroy', $imageSlider) }}" onsubmit="return confirm('Are you sure to delete?')" method="POST" class="form-inline d-inline">
                                            @csrf
                                            @method('delete')
