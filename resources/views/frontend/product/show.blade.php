<x-app-layout>
    ...
    <section class="ribbon">
        <img src="{{ get_uploads_url($product->banner_image) }}" alt="{{ $product->name }}" class="ribbonImage" />
    </section>
                ...
                <div class="col-md-7 col-sm-12 flex-grow-1">
                    <div class="product-content bg-white p-4">
                        <div class="product-brand">
                            ...
                            <img src="{{ get_uploads_url($product->brand_logo) }}" alt="brand-logo" class="{{ $product->name }}" />
                            @endif
                        </div>
                                    ...
                                    <ol class="resource-download-list">
                                        ...
                                        <li>
                                            <div class="flex">
                                                ...
                                                <a href="{{ $download->downloadUrl() }}" class="btn btn-theme-primary">
                                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
