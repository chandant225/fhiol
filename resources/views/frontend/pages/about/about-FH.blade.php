<x-app-layout>
    ...
    <section class="about-hollows">
                    ...
                    <div class="col-md-6">
                        ...
                        <ul>
                            <li>
                                ...
                                <span>To provide customized solutions to the students aspiring to study in
                                    Canada.</span>
                            </li>
                            <li>
                                <i class="fas fa-check me-2"></i>
                                <span>Strive for the organic growth of our organization through integrity, honesty, and
                                    excellence.</span>
                            </li>
                            <li>
                                <i class="fas fa-check me-2"></i>
                                <span>To build a strong and credible relationship with the partner institutions by
                                    recognizing shared values & goals.</span>
                            </li>
                        </ul>
        ...
        <div class="section section-pad-lg video-sec has-parallax overlay"
            style="background-image: url(&quot;https://images.unsplash.com/photo-1551076805-e1869033e561?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80&quot;);">
            <div class="d-flex justify-content-center">
                <a class="btn round video-pop" href="https://www.youtube.com/watch?v=iaj8ktgL3BY"><i
